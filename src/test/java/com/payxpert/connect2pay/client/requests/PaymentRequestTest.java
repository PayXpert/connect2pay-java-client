...
public class PaymentRequestTest {
  ...
  public PaymentRequestTest() {
    ...
    REQUEST_FIELDS.add(new FieldState("affiliationFields", "affiliateId", false));
    REQUEST_FIELDS.add(new FieldState("affiliationFields", "campaignName", false));
  ...
  public static PaymentRequest getDefaultRequest() {
    ...
    request.setPaymentMethod(PaymentMethod.CREDIT_CARD).setPaymentMode(PaymentMode.SINGLE)
  ...
  public static PaymentRequest getDefaultFullRequest() {
    ...
    request.setAffiliateId("3526378").setCampaignName("Unit Test Campaign");
