...
public class TransactionAttemptTest {
  ...
  public void TransactionAttemptCreationTest() {
    ...
    assertEquals(PaymentMethod.CREDIT_CARD, trans1.getPaymentType());
    ...
    CreditCardPaymentMeanInfo paymentMean = trans1.getCreditCardPaymentMeanInfo();
  ...
  public TransactionAttempt getDefaultTransactionAttempt() {
    ...
    trans1.setPaymentType(PaymentMethod.CREDIT_CARD);
    ...
    strBuilder.append("\"cardNumber\":").append('"').append("411111XXXXXX1111").append('"');
